      ...
      <div class="gradient-border">
        <q-card class="login-card q-pa-xl" flat>
          ...
          <div class="text-center q-mb-lg">
            ...
            <div class="text-h4 text-weight-medium text-grey-9 q-mb-sm">Welcome to PrimeLand!</div>
            <span class="text-subtitle1 text-grey-6">Sign in to continue</span>
          </div>

          <!-- Formulário -->
          <div class="q-gutter-y-md">
            <div>
              <label class="text-subtitle1 text-weight-medium text-grey-9 q-mb-sm block"
                >Email</label
              >
              <q-input
                v-model="email"
            ...
            <div class="flex items-center justify-between q-mt-sm q-mb-lg">
              <q-checkbox v-model="rememberMe" label="Remember me" />
              <span class="text-primary cursor-pointer text-weight-medium">Forgot password?</span>
            </div>

            <q-btn label="Sign In" color="primary" class="full-width" size="lg" unelevated to="/" />
          </div>
        </q-card>
      </div>
    </div>
...
.gradient-border {
  border-radius: 56px;
  padding: 0.3rem;
  background: linear-gradient(180deg, var(--q-primary) 10%, rgba(33, 150, 243, 0) 100%);
}
...
/* Ajustes para o input do Quasar manter a estética */
